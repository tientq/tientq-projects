...
public class CleanCode {
	...
	/*
	 * cach 2 public static String renderPageWithSetupsAndTeardowns(PageData
	 * pageData, boolean isSuite) throws Exception { boolean isTestPage =
	 * pageData.hasAttribute("Test"); if (isTestPage) { WikiPage testPage =
	 * pageData.getWikiPage(); StringBuffer newPageContent = new StringBuffer();
	 ...
	 * pageData.getHtml(); }
	 * 
	 * private static void includeTeardownPages(WikiPage testPage, StringBuffer
	 * newPageContent, boolean isSuite) { // TODO Auto-generated method stub
	 * 
	 * }
	 * 
	 * private static void includeSetupPages(WikiPage testPage, StringBuffer
	 * newPageContent, boolean isSuite) { // TODO Auto-generated method stub
	 * 
	 * }
	 */
	...
	private static void includeSetupAndTeardownPages(PageData pageData,
			boolean isSuite) {
